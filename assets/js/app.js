...
document.addEventListener('DOMContentLoaded', function(){
  ...
  if(page === 'colab-home'){
    ...
    document.getElementById('xpInfo').textContent = `XP do mês ${Mock.user.xpMonth} • Total XP ${Mock.user.xpTotal}`;
  ...
  if(page === 'colab-vendas'){
    ...
    document.getElementById('xpStats').textContent = `XP do mês ${Mock.user.xpMonth} • Total XP ${Mock.user.xpTotal}`;
  }
  if(page === 'gestor-home'){
